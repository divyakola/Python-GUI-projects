...
You can use options like fill, expand, and side to control this geometry
manager. The manager handles all widgets that are packed inside the same
master widget. ... It then repeats the process for all widgets."""
